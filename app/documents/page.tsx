...
const documents: Document[] = [
  {
    id: 1,
    title: "Project Alpha – Investment Deed",
    type: "Deed",
    fileType: "pdf",
  ...
  {
    id: 2,
    title: "Project Beta – Contract Agreement",
    type: "Contract",
    fileType: "pdf",
  ...
  {
    id: 3,
    title: "Investor Participation Form",
    type: "Form",
    fileType: "png",
    fileUrl: "/documents/form.png",
    updated: "2023-12-22",
    size: "520 KB",
  },
];
    ...
    <div className="min-h-screen bg-linear-to-br from-emerald-100 via-gray-50 to-emerald-50 p-8">
      ...
      <div className="max-w-5xl mx-auto mb-10">
        ...
        <p className="text-emerald-700/70 mt-1">
          View and download your legal documents, deeds, agreements and project
          contracts.
        </p>
      </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-hidden">
            ...
            <div className="flex items-center justify-between p-6 border-b border-emerald-200/30">
              <div>
                <h2 className="text-xl font-semibold text-emerald-900">{selectedDoc.title}</h2>
                <p className="text-sm text-emerald-700/70">{selectedDoc.type} • {selectedDoc.size}</p>
              </div>
              <button
                onClick={closeModal}
              ...
              {selectedDoc.fileType === 'pdf' ? (
                <div className="flex items-center justify-center h-96 bg-gray-100 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="text-emerald-700">PDF Document Viewer</p>
                    <p className="text-sm text-emerald-600/70 mt-2">Embedded PDF viewer would go here</p>
                  </div>
                </div>
                ...
                <div className="flex items-center justify-center h-96 bg-gray-100 rounded-lg">
                  <div className="text-center">
                    ...
                    <p className="text-sm text-emerald-600/70 mt-2">Image viewer would display here</p>
                  </div>
                </div>
              ) : (
                <div className="flex items-center justify-center h-96 bg-gray-100 rounded-lg">
